return {
    ...
    group_attack_type_filters_title = { en = "Attack Type Filters" },
    ...
    show_attack_type_melee_title         = { en = "Show Melee" },
    show_attack_type_melee_tt            = { en = "Show damage numbers generated by melee attacks." },
    show_attack_type_ranged_title        = { en = "Show Ranged" },
    show_attack_type_ranged_tt           = { en = "Show damage numbers generated by ranged attacks." },
    show_attack_type_explosion_title     = { en = "Show Explosion" },
    show_attack_type_explosion_tt        = { en = "Show damage numbers generated by explosions." },
    show_attack_type_buff_title          = { en = "Show Buff" },
    show_attack_type_buff_tt             = { en = "Show damage numbers generated by buff effects." },
    show_attack_type_companion_dog_title = { en = "Show Companion Dog" },
    show_attack_type_companion_dog_tt    = { en = "Show damage numbers generated by companion dog attacks." },
}